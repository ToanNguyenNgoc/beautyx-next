				...
				<ul className={style.tag_list}>
							...
							<a>
								<div className={style.tag_item_cnt}>
									<div className={style.tag_item_img}>
										<Image src={icon.locationCate} alt="" layout="responsive" />
									</div>
									<span className={style.item_name}>Gần bạn</span>
								</div>
							</a>
						</Link>
					</li>
					{tags_data.map((item) => (
						<li key={item.id} className={style.tag_item}>
							<Link href={`/ds-cua-hang?tag_name=${item.title}`}>
								<a>
									<div className={style.tag_item_cnt}>
										<div className={style.tag_item_img}>
											<Image src={item.img} alt={item.title} layout="responsive" />
										</div>
										<span className={style.item_name}>{item.text}</span>
									</div>
								</a>
							</Link>
						</li>
