...
export function ServicesTab({ keyword, location }:{ keyword:string, location:string }) {
    ...
    const { resData, totalItem, onLoadMore } = useSwrInfiniteCondition(keyword, "/services", servicesParams)
    const onViewMore = () => {
